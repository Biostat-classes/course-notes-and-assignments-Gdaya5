...
ggplot(sleep, aes(x=BrainWt, y=TotalSleep)) +
  ...
  xlab("Brain weight (g)")+ggtitle("Total sleep appears to decrease with brain weight")
```
...
What does a 95% confidence interval mean?
 A 95% confidence interval means the true population parameter value that will be 
 in a created interval 95% of the time it's created.
### 6
...
Regardless of the distribution of the data, the distribution of the means of the data can follow a normal distribution when a sample size is large enough
### 7
